    ...
    <div class="max-w-3xl mx-auto">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 text-center mb-6">
        ...
        <div class="flex justify-center gap-4 mt-8 flex-wrap">
          <div class="flex flex-col items-center gap-2 px-6 py-4 bg-gray-50 rounded-xl min-w-28">
            ...
            <p class="text-sm font-bold text-slate-900 text-center">{{ selectedPasienName }}</p>
          </div>
      ...
      <div class="grid grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
          ...
          <ol class="space-y-3">
            <li class="flex gap-3">
              <span class="flex-shrink-0 w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-600">1</span>
              <div>
                <p class="text-sm font-medium text-slate-900">Notifikasi dikirim ke pasien</p>
            ...
            <li class="flex gap-3">
              <span class="flex-shrink-0 w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-600">2</span>
              <div>
                <p class="text-sm font-medium text-slate-900">Jadwal mulai aktif hari ini</p>
                <p class="text-xs text-gray-500 mt-0.5">
            ...
            <li class="flex gap-3">
              <span class="flex-shrink-0 w-6 h-6 rounded-full bg-gray-100 flex items-center justify-center text-xs font-bold text-gray-600">3</span>
              <div>
                <p class="text-sm font-medium text-slate-900">Pantau kepatuhan pasien</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-center justify-between p-3 rounded-lg border border-teal-200 bg-teal-50">
              <div>
                <div class="flex items-center gap-2">
                  <p class="text-sm font-semibold text-slate-900">{{ form.nama_obat }}</p>
                  <span class="text-xs bg-teal-600 text-white px-2 py-0.5 rounded-full font-medium">Baru</span>
                </div>
                <p class="text-xs text-gray-500 mt-0.5">
            ...
            <div v-for="jadwal in pasienJadwalList" :key="jadwal.id"
              ...
              <div>
                <p class="text-sm font-medium text-slate-900">{{ jadwal.nama_obat }}</p>
                <p class="text-xs text-gray-500 mt-0.5">
