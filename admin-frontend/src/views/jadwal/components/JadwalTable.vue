  ...
  <div class="p-8">
    ...
    <div class="flex justify-between items-center mb-8">
      <div>
        <h1 class="text-2xl font-bold text-slate-900">Jadwal Obat</h1>
        <p class="text-sm text-gray-500 mt-1">Selamat datang, Ns. Sari Dewi</p>
      </div>
      <button
        @click="$emit('open-add')"
        class="px-5 py-2.5 bg-teal-600 text-white rounded-lg hover:bg-teal-700 transition font-medium text-sm flex items-center gap-2 shadow-sm"
      >
